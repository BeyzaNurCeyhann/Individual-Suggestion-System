        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name">Ahu Şahin<span class="hidden-md-down"> </span></span>
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        <?php
          if((!$SayfaKoduDegeri) or ($SayfaKoduDegeri == "") or ($SayfaKoduDegeri ==0)){
              ...
              include($Sayfa[0]);
              //include('hesabim_layouts/_tumoneriler.php');
          }elseif($SayfaKoduDegeri ==1){
              //include($SayfaKoduDegeri);
              //include($Sayfa[1]);
              include($_REQUEST["yol"]);
            }elseif($SayfaKoduDegeri ==2){
              include($Sayfa[2]);
            }                    
         ?>
      </div>
      ...
      <footer class="sl-footer">
        <div class="footer-left">
          <div class="mg-b-2">Turkuaz &copy; 2022</div>
          <div>Made by Turkuaz Seramik</div>
        </div>
