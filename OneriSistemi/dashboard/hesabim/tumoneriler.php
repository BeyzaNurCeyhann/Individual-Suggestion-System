...
<html lang="en">
  ...
  <head>
    ...
    <!-- For DataTable -->
    <link href="../../dashboard_assets/lib/highlightjs/github.css'?>" rel="stylesheet">
    <link href="../../dashboard_assets/lib/datatables/jquery.dataTables.css'?>" rel="stylesheet">
    <!-- Starlight CSS -->
    <link rel="stylesheet" href="../../dashboard_assets/css/starlight.css">
  </head>

  <body>
    <!-- ########## SOL PANEL BAŞLANGICI ########## -->
    ...
    <!-- ########## BAŞLIK PANELİ BİTİŞİ ########## -->

    <!-- ########## MAIN PANEL BAŞLANGICI ########## -->
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        <div class="sl-page-title"><h5>Tüm Kart Formaları</h5></div>
            <div class="card pd-20">
              <div class="table-responsive">
                <table id="table_tum_oneri_formlari" class="table table-bordered table-hover table-responsive bg-white">
                  <thead>
                    <th>No</th>
                    <th>Öneri Kategorisi</th>
                    <th>Tarihi</th>
                    <th>Öneri Başlılğı</th>
                    <th>Durum</th>
                    <th>Top Puan</th>
                    <th>Sorumlu Yöneticisi</th>
                    <th>Çözüm Sorumlu</th>
                    <th>Araçlar</th>
                  </thead>
                  <tbody>
                          ...
                          if($tumOneriler != false && !empty($tumOneriler))
                          {
                            foreach($tumOneriler as $row){
                                echo '<tr role="row" class="odd">
                                        ...
                                        <td> '.$row["durum"].'          </td>
                                        <td> 100         </td>
                                        <td> Sorumlu Yöneticisi   </td>
                                        <td> Çözüm Sorumlu  </td>
                                        <td> 
                                          <button type="button" class="btn btn-primary oneriGoster" data-toggle="modal" data-target="#exampleModal">
                                            Detay
                                          </button>   
                                        </td>
                                      </tr>' ; 
    ...
    <!-- DATA TABLE -->
    <script src="../../dashboard_assets/lib/highlightjs/highlight.pack.js'?>"></script>
    <script src="../../dashboard_assets/lib/datatables/jquery.dataTables.js'?>"></script>
    <script src="../../dashboard_assets/lib/datatables-responsive/dataTables.responsive.js'?>"></script>
