...
<html lang="en">
  ...
  <body>
      ...
      <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="chart-morris.html" class="nav-link">Kabul Olan Öneriler</a></li>
    ...
    <div class="sl-header">
      <div class="sl-header-left">
        ...
        <div class="navicon-left hidden-lg-up"><a id="btnLeftMenuMobile" href=""><i class="icon ion-navicon-round"></i></a></div>
                ...
                <!-- DEĞİŞTİRDİĞİM SAĞ KISIM VE PROFİL KISMI!!!!!!!!!!! -->
      <!--
      ...
      <div class="sl-pagebody">
                    ...
                    <div class="col-xl-4 mg-t-20 mg-xl-t-0">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <img src="../../dashboard_assets/img/img10.jpg" alt="">
                            <div class="media-body">
                                <div class="msg-top">
                            ...
                            <a href="" class="list-group-item list-group-item-action media">
                            <img src="../../dashboard_assets/img/img9.jpg" alt="">
                            <div class="media-body">
                                <div class="msg-top">
                            ...
                            <a href="" class="list-group-item list-group-item-action media">
                            <img src="../../dashboard_assets/img/img8.jpg" alt="">
                            <div class="media-body">
                                <div class="msg-top">
                            ...
                            <a href="" class="list-group-item list-group-item-action media">
                            <img src="../../dashboard_assets/img/img7.jpg" alt="">
                            <div class="media-body">
                                <div class="msg-top">
    ...
    <script src="../../dashboard_assets/js/ResizeSensor.js"></script>
