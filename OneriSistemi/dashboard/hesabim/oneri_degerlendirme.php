...
<div class="form">
  ...
  <div class="card pd-20 pd-sm-40">
    <h6 class="card-body-title"> ÖNERİ DEĞERLENDİRME</h6>
      ...
      <div class="row mg-b-25">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="kullanici_id" placeholder="Ad-Soyad" value="<?php echo $cek["kullanici_id"] ?>" readonly>
          </div>
        </div><!-- col-4 -->
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="bolum_id" placeholder="Ör:Bilgi İşlem" value="<?php echo $cek["bolum_id"] ?>" readonly>
          </div>
        </div><!-- col-4 -->
        ...
        <div class="col-lg-12">
          <div class="form-group">
              ...
              <input class="form-control" type="text" name="baslik" placeholder="Ör:Fatura Ayarlamaları" value="<?php echo $cek["baslik"] ?>" readonly>
            </div>
        </div><!-- col-4 -->
        ...
        <div class="col-lg-12">
          <div class="form-group">
            <label class="form-control-label">Sorun</label>
              <textarea readonly class="form-control" name="mevcut_durum" id="" rows="5"><?php echo $cek["mevcut_durum"]?></textarea>
            </div>
        </div><!-- col-4 -->
        ...
        <div class="col-lg-12">
          <div class="form-group">
            <label class="form-control-label">Öneri: <span class="tx-danger">*</span></label>
              <textarea readonly class="form-control" name="oneri" id="" rows="5"><?php echo $cek["oneri"]?></textarea>
            </div>
        </div><!-- col-4 -->      
      </div><!-- row --> 

            <td> 
                <button type="button" class="btn btn-primary btn-sm btn-inline" data-toggle="modal" data-target="#exampleModal">DEĞERLENDİR</button> 
            </td> 
    </div><!-- form-layout -->
  </div><!-- card -->
</div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">DEĞERLENDİRME</h5>
            ...
            <div class="modal-body">
              <div id="message"></div> 
               <form id="degerlendirmeFormu" method="POST">
                  <label>Değerlendirme Yorumu:</label>
                  <input type="text" name="yorum" id="yorum" class="form-control"/> <br>

                  <label>Puan:</label>
                  <input type="number" min="1" name="puan" id="puan" class="form-control"/>

                  <div class="modal-footer">
                    <button type="button" id="degerlendirmeEkle"name="button"class="btn btn-secondary" >Ekle</button>
                  </div>
               </form>
            </div>
          </div>
